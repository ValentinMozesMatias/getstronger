...
function Navbar() {
    ...
    return (
        <nav className={nav ? "nav active" : "nav"}>
            <Link to='main' className='images' smooth={true} duration={2000}>
                <img src={images} alt=''/>
            </Link>
            <input className='menu-btn' type='checkbox' id='menu-btn' />
            <label className='menu-icon' htmlFor='menu-btn' id='menu-btn'>
            ...
            <ul className='menu'>
                ...
                <li><Link to='contact' smooth={true} duration={1000}>LogIn</Link></li>
            </ul>
        </nav>
    );
}
